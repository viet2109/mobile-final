  ...
  return (
    <>
      ...
      <View
        ...
        className="items-center bg-white  mt-36"
      >
        {/* content */}
        <View className="flex-1 items-center justify-center">
          ...
          <View className="flex-row justify-between items-center w-4/5 mt-6 px-20">
            {[0, 1, 2].map((index) => (
              <View
                key={index}
                className={`h-2 w-1/5 mx-1 ${
                  currentStage === index ? "bg-blue-bg" : "bg-gray-300"
                } rounded-full`}
                style={{
          ...
          {/* text */}
          <Text className="p-10 text-2xl font-bold mb-4 text-center">
